          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-2xl font-bold text-gray-900">RAG Data Management</h1>
                <p className="text-xs sm:text-sm text-gray-500 hidden sm:block">Manage knowledge base and training documents</p>
              </div>
            </div>
            <button 
              onClick={() => setShowUploadModal(true)}
              className="w-full sm:w-auto px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-xs sm:text-sm font-medium flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="bg-white rounded-lg shadow p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-gray-500">Total Docs</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-900">1,284</p>
                </div>
