            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">{stats?.users.total || 0}</h3>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">{stats?.mechanics.total || 0}</h3>
                  <p className="text-sm text-gray-500">Active Mechanics ({stats?.mechanics.available || 0} available)</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">{stats?.documents.total || 0}</h3>
                  <p className="text-sm text-gray-500">RAG Documents ({stats?.documents.processed || 0} processed)</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">{stats?.appointments.today || 0}</h3>
                  <p className="text-sm text-gray-500">Appointments Today ({stats?.appointments.pending || 0} pending)</p>
                </div>
              </div>
